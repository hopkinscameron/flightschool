...
// set up the module
var careersServiceModule = angular.module('careers.services');

// create the factory
careersServiceModule.factory('CareersFactory', ['$http', '$location', '$rootScope', function ($http, $location, $rootScope) {
    // set up the factory
    var factory = {};
    var appPath = ApplicationConfiguration.applicationBase + 'api';
    
    // gets careers page information 
    factory.getCareersPageInformation = function () {
        // set the endpoint
        var endpoint = appPath + '/careers';
