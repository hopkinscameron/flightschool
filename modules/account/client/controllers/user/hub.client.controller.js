...
accountModule.controller('HubController', ['$scope', '$rootScope', '$compile', '$location', '$window', '$timeout', 'Service', 'AccountFactory', function ($scope, $rootScope, $compile, $location, $window, $timeout, Service, AccountFactory) {
        ...
        AccountFactory.getAccountNavigation().then(function (responseAN) {
            ...
            if (!responseAN.error) {
                ...
                AccountFactory.getHubPageInformation().then(function (responseH) {
                    ...
                    if (!responseH.error) {
                        // set the data
                        $scope.account = responseH;
                        $scope.account.navigation = responseAN;
                        $scope.account.title = 'Hubs';
