...
// set up the module
var tripsServiceModule = angular.module('trips.services');

// create the factory
tripsServiceModule.factory('TripsFactory', ['$http', '$location', '$rootScope', function ($http, $location, $rootScope) {
    // set up the factory
    var factory = {};
    var appPath = ApplicationConfiguration.applicationBase + 'api';
    
    // gets trips page information 
    factory.getTripsPageInformation = function () {
        // set the endpoint
        var endpoint = appPath + '/trips';
