...
aboutModule.controller('PrivacyController', ['$scope', '$rootScope', '$compile', '$location', '$window', '$timeout', 'Service', 'AboutFactory', function ($scope, $rootScope, $compile, $location, $window, $timeout, Service, AboutFactory) {
    ...
    function getPageData() {
        ...
        AboutFactory.getPrivacyPageInformation().then(function (responseP) {
            ...
            if (responseP && !responseP.error) {
                ...
                $scope.pageTitle = $scope.privacy.title + ' | ' + ApplicationConfiguration.applicationName;
    ...
    function setUpWaypoints() {
        ...
        var waypointList = [
            { id: 'privacy-body', offset: startOffset, class: 'animated fadeIn' }
        ];
