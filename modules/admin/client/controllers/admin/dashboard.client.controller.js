...
adminModule.controller('DashboardController', ['$scope', '$rootScope', '$compile', '$location', '$window', '$timeout', 'ChartJs', 'Service', 'DashboardFactory', function ($scope, $rootScope, $compile, $location, $window, $timeout, ChartJs, Service, DashboardFactory) {
    ...
    function getPageData() {
        ...
        DashboardFactory.getDashboardPageInformation().then(function (responseD) {
            ...
            if (responseD && !responseD.error) {
                ...
                $scope.pageTitle = $scope.dashboard.title + ' | ' + ApplicationConfiguration.applicationName;
